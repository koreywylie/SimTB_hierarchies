...
% 3/17/2023 --kw-- 
%   Modified to accept hierarchy parameters (see "HIER-*" below), 
%      to create nested network of networks.
%   Instructions:
%      Script replaces original simtb_create_sP.m in simtb,
...
'HIER_degree', 2, ...        % number of parcellations/divisions at each level
'HIER_equal_size', true, ... % equally-sized blocks (true) vs. randomly sized blocks (false)
... %%%
...
% add path to saved group spatial map
SIMULATION_PARAMETERS.HIER_groupSM_file = fullfile(SIMULATION_PARAMETERS.out_path, ...
[SIMULATION_PARAMETERS.prefix, '_groupSM.mat']);  % ensures all subjs. w/ shared spatial maps, even w. randomized comp. sizes
