...
%   with heterogeneity created by deleting one sublevel split at each level
%
% Requires:
...
HIER_equal_size = false; % if false, partitions drawn from Dirichlet r.v. w/ param a = (HIER_degree,..,HIER_degree)
